...
import { forBusinessData } from './forbusinessdata';
import { smartthingdata } from './smartthingdata';
import { aidata } from './aidata';

const Navbar = () => {
  const {setthedata} = useContext(DataContext);
  const {setHoveropen} = useContext(DataContext);

  function hoverandopen() {
    document.querySelector('.menuhover').style.display = 'flex';
    document.querySelector('.menuhover').style.height = 'auto';
  }

  function hoverandclose() {
  }
    ...
    <div className='menufirst'>
      <nav className="navbar navbar-expand-lg bg-body-tertiary menunav">
        <div className="container-fluid ">
          <a className="navbar-brand samsunglogo" href="#" onClick={refreshthepage}>
          <svg
            className="icon"
            ...
            tabIndex="-1"
            >
                <rect id="Clear_space" width="120" height="32" fill="none" />
                <path
                    id="Logo_ratio"
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 ultag">
              <li className="nav-item">
                <a className="nav-link active" aria-current="page" href="#" onMouseEnter={()=>{setthedata(shop);setHoveropen(true)}} onMouseLeave={()=>{hoverandclose()}}>Shop</a>
              </li>
              <li className="nav-item">
                <a className="nav-link active" href="#" onMouseEnter={()=>{setthedata(aidata);setHoveropen(true)}} onMouseLeave={()=>{hoverandclose()}}>Ai</a>
              </li>
              <li className="nav-item">
                <a className="nav-link active" aria-current="page" href="#">Mobile</a>
              </li>
              <li className="nav-item">
                <a className="nav-link active" href="#" onMouseEnter={()=>{setthedata(tvaudio);setHoveropen(true)}} onMouseLeave={()=>{hoverandclose()}}>TV & Audio</a>
              </li>
              <li className="nav-item">
                <a className="nav-link active" aria-current="page" href="#" onMouseEnter={()=>{setthedata(appliances);setHoveropen(true)}} onMouseLeave={()=>{hoverandclose()}}>Appliances</a>
              </li>
              <li className="nav-item">
                <a className="nav-link active" href="#" onMouseEnter={()=>{setthedata(computingmenu);setHoveropen(true)}} onMouseLeave={()=>{hoverandclose()}}>Computing</a>
              </li>
              <li className="nav-item">
                <a className="nav-link active" aria-current="page" href="#" onMouseEnter={()=>{setthedata(display);setHoveropen(true)}} onMouseLeave={()=>{hoverandclose()}}>Displays</a>
              </li>
              <li className="nav-item">
                <a className="nav-link active" href="#" onMouseEnter={()=>{setthedata(accessoriesdata);setHoveropen(true)}} onMouseLeave={()=>{hoverandclose()}}>Accessories</a>
              </li>
              <li className="nav-item">
                <a className="nav-link active" aria-current="page" href="#" onMouseEnter={()=>{setthedata(smartthingdata);setHoveropen(true)}} onMouseLeave={()=>{hoverandclose()}}>SmartThings</a>
              </li>
              <li className="nav-item explore">
                <a className="nav-link active" aria-current="page" href="#" onMouseEnter={()=>{setthedata(exploreData);setHoveropen(true)}} onMouseLeave={()=>{hoverandclose()}}>Explore</a>
              </li>
              <li className="nav-item">
                <a className="nav-link active" aria-current="page" href="#" onMouseEnter={()=>{setthedata(supportData);setHoveropen(true)}} onMouseLeave={()=>{hoverandclose()}}>Support</a>
              </li>
              <li className="nav-item">
                <a className="nav-link active" aria-current="page" href="#" onMouseEnter={()=>{setthedata(forBusinessData);setHoveropen(true)}} onMouseLeave={()=>{hoverandclose()}}>For Business</a>
              </li>
              <i className="bi bi-search icons firsticon"></i>
              <i className="bi bi-cart icons"></i>
